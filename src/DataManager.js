...
const convertCountryCode = code => countryCodeConversions[code] || "404";

const dataSetToCountryObject = dataSet => ({
  [dataSet['country']]: {
    ...dataSet
  }
});
 ...
 * @returns {{country: *}[]}
 */
export const dataList = () => Object.values(data).map(e => ({
  ...e,
 ...
 */
export const countryObject = () => asList().reduce((obj, dataSet) => ({
  ...obj,
